...
PyAPI_FUNC(size_t) PyInt_AsUnsignedLong(struct _object *arg0);
#define PyInt_AsUnsignedLongLongMask PyPyInt_AsUnsignedLongLongMask
PyAPI_FUNC(size_t) PyInt_AsUnsignedLongLongMask(struct _object *arg0);
#define PyInt_AsUnsignedLongMask PyPyInt_AsUnsignedLongMask
PyAPI_FUNC(size_t) PyInt_AsUnsignedLongMask(struct _object *arg0);
#define PyInt_FromSize_t PyPyInt_FromSize_t
PyAPI_FUNC(struct _object *) PyInt_FromSize_t(size_t arg0);
